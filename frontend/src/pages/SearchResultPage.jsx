...
//     // If there's no search query, return all listings
...
// return (
//     // 'container', 'mx-auto' centers the page. 'max-w-7xl' restricts ultra-wide screens.
...
//           </svg>
//           <h2 className="text-xl font-semibold text-gray-800">No properties found</h2>
//           <p className="text-gray-500 mt-2 text-center max-w-md">
//             We couldn't find any listings matching "{searchParams.get("q")}". Try adjusting your search or exploring our homepage.
//           </p>
//         </div>
//       )}
//     </main>
